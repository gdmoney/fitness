...
01.15 ***`Cardio  `*** **run:** 1m  
**Mon** - good run. **Tue** - good workout. **Wed** - didn't feel great after sleeping poorly for no apparent reason; OHP was moderate/heavy; bench was light/moderate. **Thur** - pullups felt strong; first time doing the farmer's walk; it was moderate; use chalk next time. **Fri** - 
