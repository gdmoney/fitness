...
04.18 ***`Cardio  `*** **run:** 2m   
04.17 ***`        `***   
**Mon** - rest. **Tue** - run felt good. **Wed** - squat was moderate/heavy with good form; aggravated my lower back pain. **Thur** - rest. **Fri** - rest; felt like shit. **Sat** - OHP was moderate; slight left shoulder and lower back pain during the movement. **Sun** -
